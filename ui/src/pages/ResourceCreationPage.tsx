                    ...
                    <Card
                        ...
                        <CardHeader className="p-6">
                            ...
                            <CardDescription className="text-gray-600 dark:text-gray-400">
                                Select a cloud resource type you want to create and describe the configuration to
                                generate IaC code.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="p-6 space-y-4">
                            <Select value={selectedResource} onValueChange={setSelectedResource}>
                                ...
                                <SelectContent
                                    className="border-gray-200 rounded-lg dark:border-gray-700 bg-white dark:bg-gray-800">

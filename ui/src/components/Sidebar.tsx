...
import { Home, FileText, LifeBuoy, LogOut, ChevronsLeft, ChevronsRight, CirclePlus } from "lucide-react";
    ...
    >
      ...
      <div className="flex-1">
        <nav className="space-y-2">
          {navigation
            .filter((item) => {
              // Only allow "Create User" for admin role
              if (item.name === "Create User" && role !== "admin") {
                return false;
              }
              return true;
            })
